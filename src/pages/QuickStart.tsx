...
export default function QuickStart() {
  ...
  const description = 'Start with budabit.club: explore or create developer communities, curate important knowledge, grant permissions, and optionally add relay or Blossom infrastructure later.';
        ...
        <div className="container mx-auto px-6">
          ...
          <section className="mx-auto mt-12 grid max-w-6xl gap-4 md:grid-cols-2">
            {onboardingSteps.map((step) => (
              ...
              >
                ...
                <p className="mt-3 break-words text-sm leading-relaxed text-muted-foreground">{step.body}</p>
              </article>
            ))}
          </section>
          ...
          <section className="mx-auto mt-14 max-w-6xl">
            <div className="mb-6 max-w-3xl">
              <p className="text-sm font-mono uppercase tracking-[0.18em] text-primary">Community setup</p>
              <h2 className="mt-3 text-3xl font-bold tracking-tight md:text-4xl">
                Shape the community before thinking about infrastructure.
              </h2>
              <p className="mt-4 text-muted-foreground">
                The first decisions are social and editorial: what your community curates, who can publish in each section, and which moderators can help keep the signal high.
              </p>
            </div>
          ...
          >
            <div className="grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
              <div>
                <p className="text-sm font-mono uppercase tracking-[0.18em] text-primary">Optional infrastructure</p>
