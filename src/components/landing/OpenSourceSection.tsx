      ...
      <div className="container mx-auto px-6" ref={ref}>
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className={cn(
            ...
            Open source gave us shared code.{' '}
            <span className="text-primary">Open protocols give us shared coordination.</span>
          </h2>
          ...
          <p className={cn(
            ...
            BudaBit is free and open source software built on Nostr. Discussions, community curation, access grants, reviews, moderation, and reputation become signed events that any compatible client can read, verify, and display.
          </p>
          ...
          <div className={cn(
            ...
            <div className="flex items-center gap-2 px-5 py-3 border-b border-border/30">
              ...
              <span className="text-muted-foreground text-xs font-mono ml-2">targeted-publication.json</span>
            </div>
            <pre className="p-5 text-sm font-mono leading-relaxed overflow-x-auto">
              <code>
                <span className="text-muted-foreground">{'{'}</span>{'\n'}
                <span className="text-primary/70">  &quot;kind&quot;</span><span className="text-muted-foreground">:</span> <span className="text-orange-400/80">30222</span><span className="text-muted-foreground">,</span>{'\n'}
                ...
                <span className="text-primary/70">  &quot;tags&quot;</span><span className="text-muted-foreground">:</span> <span className="text-green-400/70">[[&quot;p&quot;, &quot;community...&quot;], [&quot;k&quot;, &quot;30617&quot;]]</span><span className="text-muted-foreground">,</span>{'\n'}
